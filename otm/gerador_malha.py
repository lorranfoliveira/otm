...
class GeradorMalha:
    ...
    @staticmethod
    def exibir_malha(arquivo: pathlib.Path, numeracao=True, tamanho_numeracao=1):
        """Exibe a malha final gerada"""
        logger.info('Criando o desenho da malha final')

        # Leitura dos arquivos
        elementos = ler_arquivo_entrada_dados_numpy(arquivo, 0)
        nos = ler_arquivo_entrada_dados_numpy(arquivo, 1)
        pol = ler_arquivo_wkb_shapely(arquivo, 10)
